...
const appCss = "/assets/styles-CNjTnPhx.css";
...
const $$splitComponentImporter = () => import("./index-BDjX52UP.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Alongamentos de unhas em Barueri com Izabeli Silva. Fibra de vidro, molde F1, banho de gel e mais. Agende pelo WhatsApp."
    }, {
      property: "og:title",
      content: "Izabeli Nails — Nail Designer em Barueri"
    }, {
